...
import com.abid.ecommerce.email.EmailService;
...
public class NotificationConsumer {
    ...
    public void consumeOrderSuccessNotification(PaymentConfirmation paymentConfirmation) throws MessagingException {
        log.info(String.format("Consuming the message from payment-topic Topîc::%s", paymentConfirmation));
